...
// ── iotecWebhook ──────────────────────────────────────────────────────────────
exports.iotecWebhook = functions.https.onRequest(async (req, res) => {
    var _a, _b;
    // 1. Accept POST only
    if (req.method !== 'POST') {
    ...
    try {
        ...
        const body = req.body;
        const transaction = (_a = body.transaction) !== null && _a !== void 0 ? _a : body;
        const externalId = transaction.externalId;
        const iotecStatus = transaction.status;
        ...
        const postId = paymentData.postId;
        ...
        if (iotecStatus === 'Success') {
            ...
            const pushToken = (_b = payerSnap.data()) === null || _b === void 0 ? void 0 : _b.expoPushToken;
            if (pushToken) {
